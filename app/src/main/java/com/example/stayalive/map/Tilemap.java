...
import static com.example.stayalive.map.MapLayout.NUMBER_OF_COLUMN_TILES;
import static com.example.stayalive.map.MapLayout.NUMBER_OF_ROW_TILES;
import static com.example.stayalive.map.MapLayout.TILE_HEIGHT_PIXELS;
import static com.example.stayalive.map.MapLayout.TILE_WIDTH_PIXELS;
